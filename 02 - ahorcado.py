...
def obtenerPalabraAlAzar(listaDePalabras):
	# Esta funcion devuelve una cadena al azar desde la lista de cadenas pasada como argumento
...
def obtenerIntento(letrasProbadas):
	...
	while True:
		...
		if len(intento) != 1:
			...
			print('Por favor, ingresa una LETRA del alfabeto en español')
		else:
			return intento

def jugarDeNuevo():
	#Esta funcion devuelve True si el jugador quiere volver  jugar, False si no quiere
