...
# Pertenece a la primera modificacion del cuerpo
cuadradoVerdeX = anchoVentana / 2
cuadradoVerdeY = altoVentana / 2
...
while True:
	...
	pygame.draw.rect(superficieDeDibujo, (0,255,0), (cuadradoVerdeX, cuadradoVerdeY, 10, 10 ))

	# Sumando uno al valor inicial de cuadradoVerdeX
	# cuadradoVerdeX += 1
	cuadradoVerdeY += -1
