...
# Pertenece a la tercera modificacion
rectaX = anchoVentana / 2
rectaY = altoVentana / 2
anchoRecta = 50
altoRecta = 50
...
while True:
	...
	pygame.draw.rect(superficieDeDibujo, (255,255,0), (rectaX-anchoRecta/2, rectaY-altoRecta/2, anchoRecta, altoRecta))
