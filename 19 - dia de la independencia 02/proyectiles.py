class Bala_Laser():
  ...
  def verificarImpacto(self, verificarComparandoCon):
    if self.x > verificarComparandoCon.x and self.x < verificarComparandoCon.x + verificarComparandoCon.ancho:
      if self.y > verificarComparandoCon.y and self.y < verificarComparandoCon.y + verificarComparandoCon.alto:
